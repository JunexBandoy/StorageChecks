...
import { validationSchema } from 'src/models/employee';
import { LeaveModel, LeaveTypeMOdel } from 'src/models/leaveModel';
import { LeaveService } from 'src/services/LeaveService';
import { LeaveTypeService } from 'src/services/LeaveTypeService';

interface Iprops {
  leavedetails: LeaveModel | null;
  onClick: () => void;
  onClose: () => void;
}

export const LeaveEdit: React.FC<Iprops> = ({
  onClick,
  onClose,
  leavedetails,
}) => {
  ...
  const loadData = async () => {
    const data = await LeaveTypeService.getType();
    setLeaveType(data);
  };
      ...
      <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
        <div className="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
            Update {leavedetails.first_name} Leave Application
          </h3>
          <button
            type="button"
            ...
            <form onSubmit={handleSubmit} className="p-4 md:p-5">
              <div className="grid gap-4 mb-4 grid-cols-2">
                ...
                <div className="col-span-2">
                  ...
                  <Field
                    type="text" // Keep this as 'text' to avoid user input
                    name="credit"
                    className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                    readOnly
                  />
