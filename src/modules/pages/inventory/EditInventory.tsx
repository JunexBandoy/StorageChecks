...
import { inventoryModel, validationSchema } from 'src/models/Inventory';
...
export const EditInventory: React.FC<ModalProps> = ({ onClick, inventory }) => {
  const handleSubmit = async (values: inventoryModel) => {
    try {
      await InventoryServices.create(values);
